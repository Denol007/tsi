...
class IntentClassifier:
    ...
    INTENT_PATTERNS = {
        ...
        "busy_time": {
            ...
            "keywords": ["занятость", "время пар", "график занятий", "busy time", "когда занят"],
            "examples": ["Когда я занят на этой неделе?", "Время пар на месяц", "График занятости", "Со скольки до скольки пары завтра"]
        },
        "free_time": {
            "patterns": [
